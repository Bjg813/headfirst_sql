-- Create database called 'drinks'
CREATE DATABASE drinks;

-- Access the database
USE drinks;

-- Create table called 'easy_drinks'
...
(
    'Blue Moon', 'tonic water', 1.5, 'blueberry juice', .75, 'stir with ice, strain into cocktail glass with lemon twist'
),
(
